...
const About = () => {
  return (
    <section
      id="about"
      className="h-max py-[4rem] border-t border-juadeb_gray px-[6rem] relative"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-center gap-8 text-[#A9A9A9]">
          <a href="https://www.linkedin.com/in/juadebade/" target="_blank">
            <FaLinkedinIn
              size={30}
          ...
          <a href="https://www.instagram.com/juadebgabriel/" target="_blank">
            <IoLogoInstagram
              size={30}
              className="cursor-pointer border border-[#a9a9a9] p-1 rounded-full hover:border-white hover:bg-white hover:text-main_bg duration-150 transition-all ease-in"
            />
          </a>
          <a href="https://twitter.com/Juadeb1" target="_blank">
            <FaTwitter
              size={30}
              className="cursor-pointer border border-[#a9a9a9] p-1 rounded-full hover:border-white hover:bg-white hover:text-main_bg duration-150 transition-all ease-in"
            />
